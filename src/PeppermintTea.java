...
public class PeppermintTea extends Beverage
{
	...
	//Peppermint Tea has-a Identification Number
	private String ID = "11";
		
	//Peppermint Tea has-a name
	private String name = "Peppermint Tea";
		
	//Peppermint Tea has-a number count representing the amount of it being ordered
	private int count = 0;
